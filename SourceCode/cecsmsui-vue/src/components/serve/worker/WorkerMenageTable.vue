<template>
    <el-config-provider :locale="locale">
        <el-table class="desktop-people-table" :data="userData" height="450" style="width: 100%" :table-layout="tableLayout"
            ...
            <el-table-column prop="id" label="工作者编号" width="100px" />
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    <!-- 新增修改按钮 -->
                    <el-button size="small" type="primary" @click="editWorker(scope.row)">修改</el-button>
        ...
        <PeopleMobileList :items="userData" entity-label="工作者" @edit="editWorker" @deactivate="logout" />
    </el-config-provider>
</template>
